!function(a) {
    ...
    a(document).ready(function() {
        ...
        a(".typeahead").on("typeahead:selected", function() {
            ...
            limit: 6,
            templates: {
                suggestion: Handlebars.compile('<div class="row typeahead-row"><div class="col-md-2 col-sm-3"><img src="resources/upload/card/{{imagePath}}">' + '</div><div class="col-md-10 col-sm-9"><div class="row"><strong>{{title}}</strong></div><div class="row">{{description}}</div></div></div>')
            }
        });
