			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col col-xs-6 text-right">
						<a href="<c:url value="/admin/newDocument/${cardId}" />"
					...
					<tbody>
						<c:forEach items="${documents}" var="document">
							<tr>
								...
								<td>${document.name}</td>
								<td width="50%">${document.description}</td>
								<td align="center"><form
										action="<c:url value="/admin/deleteDocument/${document.id}/${cardId}" />">
										<a href="<c:url value="/admin/updateDocument/${document.id}/${cardId}" />"
