	...
	<div class="col-sm-7 col-md-7 form">
		<div class="panel panel-default">
			<div class="panel-heading">
				<c:choose>
					<c:when test="${edit}">
						<div class="panel-title">Update Child Category <span class="required">(*required fields)</span></div>
						<c:url var="actionUrl" value="/admin/updateChildCategory/${parentId}" />
					</c:when>
					<c:otherwise>
						<div class="panel-title">Add Child Category <span class="required">(*required fields)</span></div>
