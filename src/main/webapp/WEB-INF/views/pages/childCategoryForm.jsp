...
<div class="col-sm-9 col-md-9 main-content">
	<c:choose>
		<c:when test="${edit}">
			<h3>
				Update Category<span class="required">&nbsp;(*required
					fields)</span>
			</h3>
		...
		<c:otherwise>
			<h3>
				Add Category<span class="required">&nbsp;(*required fields)</span>
			</h3>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<form:form method="POST" modelAttribute="category"
				id="addChildCategory" action="${actionUrl}"
				cssClass="form-horizontal">
				<form:input type="hidden" path="id" id="id" />
				<form:input type="hidden" path="parentId" value="${parentId}"
					id="parentId" />
				<div>
					<div class="form-group">
						<label for="name" class="control-label col-md-3">Category Name<span
