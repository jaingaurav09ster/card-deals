...
<div class="col-sm-9 col-md-9 main-content">
	<c:choose>
		<c:when test="${edit}">
			<h3>
				Update Card Type<span class="required">&nbsp;(*required
					fields)</span>
			</h3>
		...
		<c:otherwise>
			<h3>
				Add Card Type<span class="required">&nbsp;(*required fields)</span>
			</h3>
			...
			<form:form method="POST" modelAttribute="cardType" id="addCardType"
				...
				<div>
					<div class="form-group">
						<label for="name" class="control-label col-md-3">Card Type<span
