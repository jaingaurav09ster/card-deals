	...
	<div class="col-sm-7 col-md-7 form">
		<div class="panel panel-default">
			<div class="panel-heading">
				<c:choose>
					<c:when test="${edit}">
						<div class="panel-title">Update Card Category <span class="required">(*required fields)</span></div>
						<c:url var="actionUrl" value="/admin/updateCardCategory" />
					</c:when>
					<c:otherwise>
						<div class="panel-title">Add Card Category <span class="required">(*required fields)</span></div>
							...
							<div class="col-md-8">
								<div class="input-group">
									<form:textarea path="description" class="form-control ckeditor"
										id="ckEditorTextArea" placeholder="Card Category Description" />
								</div>
								<div class="has-error">
