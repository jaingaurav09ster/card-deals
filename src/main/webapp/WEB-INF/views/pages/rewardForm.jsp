	...
	<div class="col-sm-4 col-md-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<c:choose>
					<c:when test="${edit}">
						<div class="panel-title">Update Reward</div>
						<c:url var="actionUrl" value="/admin/updateReward/${cardId}" />
					</c:when>
					<c:otherwise>
						<div class="panel-title">Add Reward</div>
						<c:url var="actionUrl" value="/admin/newReward/${cardId}" />
					</c:otherwise>
				</c:choose>
			</div>
				...
				<form:form method="POST" modelAttribute="reward" id="addReward"
							...
							<div class="col-xs-8">
								<div class="input-group">
									<form:textarea path="description" class="form-control ckeditor"
										id="reward" placeholder="reward Description" />
								</div>
								<div class="has-error">
					...
					<div class="form-group">
						<div class="col-xs-offset-3 col-xs-7">
							<a href="<c:url value='/admin/listRewards/${cardId}' />"
